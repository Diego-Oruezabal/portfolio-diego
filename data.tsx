...
export const dataAboutPage = [
    ...
    },
    {
        ...
        description: "",
        tags: ["WordPress", "Elementor", "SEO", "Desarrollo web"],
        highlights: [
            "Creación de sitios web corporativos con WordPress y Elementor.",
            "Optimización SEO on-page y estructuración de contenidos.",
            "Aplicación de mejoras técnicas orientadas al rendimiento y la visibilidad orgánica.",
        ],
        date: "2025 - 2026",
    },
    {
        ...
        description: "",
        tags: ["Banca de empresas", "Gestión de clientes", "Desarrollo comercial"],
        highlights: [
            "Gestión y desarrollo de la cartera de clientes empresariales.",
            "Captación de nuevos clientes y ejecución de acciones comerciales.",
        ],
        date: "2007 - 2008",
    },
    {
        ...
        description: "",
        tags: ["Gestión laboral", "Fiscalidad", "Contabilidad"],
        highlights: [
            "Dirección y coordinación del área laboral.",
            "Gestión de procesos fiscales y contables.",
        ],
        date: "2006 - 2007",
    },
    {
        ...
        description: "",
        tags: ["Auditoría interna", "Contabilidad", "Control"],
        highlights: [
            "Auditoría y control interno de la información contable.",
        ],
        date: "2005",
    },
    {
        ...
        description: "",
        tags: ["Administración pública", "Informes técnicos", "Gestión de proyectos"],
        highlights: [
            "Asesoramiento técnico y elaboración de informes para la Administración.",
...
export const dataAboutPageEn = [
  ...
  },
  {
    ...
    subtitle: "Incorpora Marketing · Granada",
    description: "",
    tags: ["WordPress", "Elementor", "SEO", "Web Development"],
    highlights: [
      "Creation of corporate websites with WordPress and Elementor.",
      "On-page SEO optimization and content structuring.",
      "Implementation of technical improvements focused on performance and organic visibility.",
    ],
    date: "2025 - 2026",
  },
  {
    ...
    subtitle: "Banco Santander",
    description: "",
    tags: ["Corporate Banking", "Client Management", "Business Development"],
    highlights: [
      "Management and development of a corporate client portfolio.",
      "New client acquisition and execution of commercial initiatives.",
    ],
    date: "2007 - 2008",
  },
  {
    ...
    description: "",
    tags: ["HR Management", "Taxation", "Accounting"],
    highlights: [
      "Leadership and coordination of the labor department.",
      "Management of tax and accounting processes.",
    ],
    date: "2006 - 2007",
  },
  {
    ...
    description: "",
    tags: ["Internal Audit", "Accounting", "Controls"],
    highlights: [
      "Internal audit and control of accounting information.",
    ],
    date: "2005",
  },
  {
    id: 5,
    title: "Domestic Trade, Tourism and Industry Technician",
    subtitle: "Granada Chamber of Commerce",
    description: "",
    tags: ["Public Administration", "Technical Reporting", "Project Management"],
    highlights: [
      "Technical advice and report preparation for public administration.",
...
export const dataCounter = [
    {
        ...
        endCounter: 18,
        prefix: "+ ",
        text: "Años gestionando operaciones",
        lineRight: true,
    ...
    },
    {
        ...
        endCounter: 2,
        prefix: "",
        text: "Sistemas de calidad: Q + ISO 9001",
        lineRight: false,
        lineRightMobile: false,
    },
];
...
export const dataCounterEn = [
    {
        ...
        endCounter: 18,
        prefix: "+ ",
        text: "Years managing operations",
        lineRight: true,
        lineRightMobile: true,
    },
    {
    ...
    },
    {
        ...
        endCounter: 2,
        prefix: "",
        text: "Quality systems: Q + ISO 9001",
        lineRight: false,
        lineRightMobile: false,
    },
];
