import { dataTrainingPage } from "@/data";
import { usePathname } from "next/navigation";
import { getDataTrainingPage } from "@/data";

const TimeTrainingLine = () => {
  const pathname = usePathname();
  const lang = pathname.startsWith("/en") ? "en" : "es";
  const data = getDataTrainingPage(lang);
    return (
...
export default TimeTrainingLine;